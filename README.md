...
Measured code fragments include sending a GET request to "https://api.github.com/users/octocat/repos" resource and unmarshalling the response json string to the 
